...
const extractChainId = (id: string): string => {
  // If the ID is undefined or null, return empty string
  if (!id) {
    return "";
  }
...
export function PulseSwapsColumn() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      console.log("Here: fetching recent swaps");
      ...
      try {
        ...
        console.log("Here: fetching recent swaps 2");
        ...
        console.log("Here: fetching recent swaps 3");
        ...
        console.log("Here: fetching recent swaps 4");

        // Update counter for next batch
        animationCounterRef.current += newSwaps.length;

        console.log("Here: fetching recent swaps 5");
          ...
          <div className="space-y-1.5">
            <AnimatePresence initial={false}>
              {swaps.map((swap) => {
                ...
                const chainId = extractChainId(swap.pool);
                const networkName =
